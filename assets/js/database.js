const ocarinas = [
    {
        ...
        description: `This pre-Columbian composite zoomorph, like the little bird (${'<a href="#">#10028</a>'}), is around 2,000 years old and comes from the Nicoya peninsula on the Pacific coast of Costa Rica, from the Catalina phase of the Chorotega culture. Both vessel flutes have 4 equal-size finger holes offering five different fingering combinations and, this case, a range of just over a 5th, from D flat to A. Both are exquisitely made to produce a wonderfully pure sound. ${'<br><br>'} Players 2,000 years ago are unlikely to have played tunes as we would, but probably glissandoed & flutter-tongued to bring their creations to life, making them sing and purr like the creatures they depict.`,
